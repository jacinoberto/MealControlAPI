...
public class DuplicateTeamManagementSectorError : IValidateStrategy<TeamManagement>
{
    private readonly MealControlDbContext _context;

    public DuplicateTeamManagementSectorError(MealControlDbContext context)
    {
        _context = context;
    }
